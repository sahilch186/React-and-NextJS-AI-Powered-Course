    ...
    <div className="isolate bg-white px-6 py-12 sm:py-16 lg:px-8">
      ...
      >
        <div
          ...
          className="relative left-1/2 -z-10 aspect-1155/678 w-144.5 max-w-none -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-10rem)] sm:w-288.75 bottom-[10rem]"
        />
      </div>
